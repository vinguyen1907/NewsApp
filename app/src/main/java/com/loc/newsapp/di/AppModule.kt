...
import com.loc.newsapp.domain.usecases.news.DeleteBookmark
...
import com.loc.newsapp.domain.usecases.news.SelectBookmarks
import com.loc.newsapp.domain.usecases.news.UpsertBookmark
...
class AppModule {
    ...
    fun provideNewsUseCases(
        ...
        upsertBookmark = UpsertBookmark(newsDao),
        selectBookmarks = SelectBookmarks(newsDao),
        deleteBookmark = DeleteBookmark(newsDao),
